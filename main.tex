...
\begin{figure}[H]%[htbp]
    ...
    \caption{Comparaison entre les émissions de CO\textsubscript{2}e pour la phase de fabrication et d’utilisation des Raspberry Pi et des serveurs}
...
\textcolor{red}{decrire les résulast ici}
...
\textcolor{blue}{[Question 11]}~Dans cette étude, nous avons modélisé l'impact environnemental pour six serveurs, néanmoins, en cas de panne, cette quantitée peut s'averer insuffisnate. Nous avons donc modélisé l'impact environnemental pour huit serveurs ce qui à présenté une très légère augmentation de l'impacte de la solution comme le présente la figure~\ref{fig:8vs6vsDELL}, ce qui ne chnage donc pas notre conclusion initial. En effet, nous avons pu observer que l'impact environnemental de la solution Raspberry Pi est bien plus faible que celui de l'ordinateur Dell T1700/3620.\\
