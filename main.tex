...
\textcolor{blue}{[Question 10-1]}~Dans notre étude, nous avons pu évaluer l'impacte environnemental de deux solutions pour le parc informatique de l'ENSEIRB-MATMECA : 600 ordinateurs Dell de type tour T1700/3620 et 600 Raspberry Pi 4 Rev B connectés à 6 serveurs Dell Precision 7920T. Nous avons pu constater que le parc informatique actuel à un impact environnemental très élevé, avec un impacte par étudiant durant sa scolarité qui s'élève à \textcolor{red}{XXXXX} kg CO\textsubscript{2}e. En revanche, la solution des Raspberry Pi couplés à des serveurs présente un impact environnemental bien plus faible, avec un impacte divisé par 10.\\ \\
Nénanmois nosu avons pu observer que la mise en place de cette solution est complexe et coûteuse, nécessitant un investissement important. De plus, il est important de noter que l'impact environnemental des Raspberry Pi et des serveurs peut varier en fonction de leur utilisation et de leur configuration.\\
