...
\begin{figure}[H]%[htbp]
    ...
    \caption{Comparaison entre six cent Raspberry Pi couplés à huit serveurs, six cent Raspberry Pi couplés à six serveurs et six cent ordinateur Dell de type tour T1700/3620}
    \label{fig:8vs6vsDELL}
\end{figure}

La figure \ref{fig:8vs6vsDELL} représente la différence de l'impact environnementaux des 2 stratégies, ainsi que celle entre le choix de 6 ou 8 serveurs pour la stratégies combinant des Raspberry Pi et des serveurs.
Nous pouvons identifier que la stratégie consistant à installer 600 ordinateurs Dell de type tour T1700/3620 a un impact environnemental eviron 10 fois supérieur aux autres scénarios étudiés, et ce quelque soit la catégorie d'impact.
Parmis les 2 scénarios implémentant des Raspberry Pi a des serveurs, si les impacts environnementaux du scénario optant pour 8 serveurs sont légèrement supérieurs, ils restent cependant très proche de celui n'en ayant que 6.

\LaTeX

Nous avons pu observer qui si le fait de mettre en oeuvre 8 serveurs au lieu de 6 augmentait les impact environnementaux, cette augmentation est très faible voir négligeable dans le contexte d'une comparaison avec la stratégie consistant à déployer 600 ordinateurs Dell de type tour T1700/3620.
